  ...
  return (
    <section className="py-20 sm:py-28 bg-bg-alt">
      <div className="max-w-[1200px] mx-auto px-6 lg:px-8">
        ...
        <motion.div initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: 0.15 }} className="grid grid-cols-2 md:grid-cols-4 gap-5">
